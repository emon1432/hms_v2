				...
				<form method="post" action="" name="frmtreat" onSubmit="return validateform()">
					<div class="row">
						<div class="col-sm-4 col-xs-12">
							<div class="form-group">
								...
								<div class="form-line">
									<input type="text" class="form-control" name="treatmenttype" id="treatmenttype" value="<?php echo $rsedit['treatmenttype']; ?>">
								</div>
							</div>
						</div>
						<div class="col-sm-4 col-xs-12">
							<div class="form-group">
								...
								<div class="form-line">
									<input type="text" class="form-control" name="treatmentcost" id="treatmentcost" value="<?php echo $rsedit['treatment_cost']; ?>" />
								</div>
							</div>
						</div>
						<div class="col-sm-4 col-xs-12">
					...
					<div class="col-sm-12">
						<div class="form-group">
							...
							<div class="form-line">
								<textarea name="textarea" class="form-control no-resize" id="textarea" cols="45" rows="5"><?php echo $rsedit['note']; ?></textarea>
