...
CREATE TABLE `admin` (
  ...
  `adminname` varchar(25) NULL DEFAULT NULL,
  `loginid` varchar(25) NULL DEFAULT NULL,
...
CREATE TABLE `appointment` (
  `appointmentid` int(10) NULL DEFAULT NULL,
  `appointmenttype` varchar(25) NULL DEFAULT NULL,
  ...
  `status` varchar(10) NULL DEFAULT NULL,
  `app_reason` text NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `billing` (
  `billingid` int(10) NULL DEFAULT NULL,
  `patientid` int(10) NULL DEFAULT NULL,
  `appointmentid` int(10) NULL DEFAULT NULL,
  `billingdate` date NULL DEFAULT NULL,
  `billingtime` time NULL DEFAULT NULL,
  `discount` float(10,2) NULL DEFAULT NULL,
  `taxamount` float(10,2) NULL DEFAULT NULL,
  `discountreason` text NULL DEFAULT NULL,
...
CREATE TABLE `billing_records` (
  `billingservice_id` int(10) NULL DEFAULT NULL,
  `billingid` int(10) NULL DEFAULT NULL,
  `bill_type_id` int(10) NULL DEFAULT NULL COMMENT 'id of service charge or treatment charge',
  `bill_type` varchar(250) NULL DEFAULT NULL,
  `bill_amount` float(10,2) NULL DEFAULT NULL,
...
CREATE TABLE `doctor` (
  `doctorid` int(10) NULL DEFAULT NULL,
  `doctorname` varchar(50) NULL DEFAULT NULL,
  `mobileno` varchar(15) NULL DEFAULT NULL,
  `departmentid` int(10) NULL DEFAULT NULL,
  `loginid` varchar(25) NULL DEFAULT NULL,
  `password` varchar(25) NULL DEFAULT NULL,
  `status` varchar(10) NULL DEFAULT NULL,
  `education` varchar(25) NULL DEFAULT NULL,
  `experience` float(11,1) NULL DEFAULT NULL,
  `consultancy_charge` float(10,2) NULL DEFAULT NULL,
...
CREATE TABLE `doctor_timings` (
  `doctor_timings_id` int(10) NULL DEFAULT NULL,
  `doctorid` int(10) NULL DEFAULT NULL,
  `start_time` time NULL DEFAULT NULL,
  `end_time` time NULL DEFAULT NULL,
  `available_day` varchar(15) NULL DEFAULT NULL,
  `status` varchar(10) NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `medicine` (
  `medicineid` int(10) NULL DEFAULT NULL,
  `medicinename` varchar(25) NULL DEFAULT NULL,
  `medicinecost` float(10,2) NULL DEFAULT NULL,
  `description` text NULL DEFAULT NULL,
  `status` varchar(10) NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `orders` (
  ...
  `patientid` int(10) NULL DEFAULT NULL,
  `doctorid` int(10) NULL DEFAULT NULL,
  `prescriptionid` int(10) NULL DEFAULT NULL,
  ...
  `cvv_no` varchar(5) NULL DEFAULT NULL,
  `expdate` date NULL DEFAULT NULL,
  `card_holder` varchar(50) NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `patient` (
  `patientid` int(10) NULL DEFAULT NULL,
  `patientname` varchar(50) NULL DEFAULT NULL,
  `admissiondate` date NULL DEFAULT NULL,
  `admissiontime` time NULL DEFAULT NULL,
  ...
  `password` varchar(25) NULL DEFAULT NULL,
  `bloodgroup` varchar(20) NULL DEFAULT NULL,
...
CREATE TABLE `payment` (
  `paymentid` int(10) NULL DEFAULT NULL,
  `patientid` int(10) NULL DEFAULT NULL,
  `appointmentid` int(10) NULL DEFAULT NULL,
  `paiddate` date NULL DEFAULT NULL,
  `paidtime` time NULL DEFAULT NULL,
  `paidamount` float(10,2) NULL DEFAULT NULL,
  `status` varchar(10) NULL DEFAULT NULL,
  `cardholder` varchar(50) NULL DEFAULT NULL,
  `cardnumber` int(25) NULL DEFAULT NULL,
  `cvvno` int(5) NULL DEFAULT NULL,
  `expdate` date NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `prescription` (
  `prescriptionid` int(10) NULL DEFAULT NULL,
  `treatment_records_id` int(10) NULL DEFAULT NULL,
  `doctorid` int(10) NULL DEFAULT NULL,
  `patientid` int(10) NULL DEFAULT NULL,
  `delivery_type` varchar(10) NULL DEFAULT NULL COMMENT 'Delivered through appointment or online order',
  `delivery_id` int(10) NULL DEFAULT NULL COMMENT 'appointmentid or orderid',
...
CREATE TABLE `prescription_records` (
  `prescription_record_id` int(10) NULL DEFAULT NULL,
  `prescription_id` int(10) NULL DEFAULT NULL,
  `medicine_name` varchar(25) NULL DEFAULT NULL,
  `cost` float(10,2) NULL DEFAULT NULL,
  `unit` int(10) NULL DEFAULT NULL,
  `dosage` varchar(25) NULL DEFAULT NULL,
  `status` varchar(10) NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `room` (
  `roomid` int(10) NULL DEFAULT NULL,
  `roomtype` varchar(25) NULL DEFAULT NULL,
  `roomno` int(10) NULL DEFAULT NULL,
  `noofbeds` int(10) NULL DEFAULT NULL,
  `room_tariff` float(10,2) NULL DEFAULT NULL,
  `status` varchar(10) NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `service_type` (
  ...
  `servicecharge` float(10,2) NULL DEFAULT NULL,
  `description` text NULL DEFAULT NULL,
  `status` varchar(10) NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `treatment` (
  `treatmentid` int(10) NULL DEFAULT NULL,
  `treatmenttype` varchar(25) NULL DEFAULT NULL,
  `treatment_cost` decimal(10,2) NULL DEFAULT NULL,
  `note` text NULL DEFAULT NULL,
  `status` varchar(10) NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `treatment_records` (
  ...
  `uploads` varchar(100) NULL DEFAULT NULL,
  `treatment_date` date NULL DEFAULT NULL,
  `treatment_time` time NULL DEFAULT NULL,
  `status` varchar(10) NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `user` (
  ...
  `createddateandtime` datetime NULL DEFAULT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `admin`
  MODIFY `adminid` int(10) NULL DEFAULT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `appointment`
--
ALTER TABLE `appointment`
  MODIFY `appointmentid` int(10) NULL DEFAULT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `billing`
--
ALTER TABLE `billing`
  MODIFY `billingid` int(10) NULL DEFAULT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `billing_records`
--
ALTER TABLE `billing_records`
  MODIFY `billingservice_id` int(10) NULL DEFAULT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `department`
--
ALTER TABLE `department`
  MODIFY `departmentid` int(10) NULL DEFAULT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `doctor`
--
ALTER TABLE `doctor`
  MODIFY `doctorid` int(10) NULL DEFAULT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `doctor_timings`
--
ALTER TABLE `doctor_timings`
  MODIFY `doctor_timings_id` int(10) NULL DEFAULT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
-- AUTO_INCREMENT for table `medicine`
--
ALTER TABLE `medicine`
  MODIFY `medicineid` int(10) NULL DEFAULT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `orders`
--
ALTER TABLE `orders`
  MODIFY `orderid` int(10) NULL DEFAULT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
--
-- AUTO_INCREMENT for table `patient`
--
ALTER TABLE `patient`
  MODIFY `patientid` int(10) NULL DEFAULT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `payment`
--
ALTER TABLE `payment`
  MODIFY `paymentid` int(10) NULL DEFAULT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `prescription`
--
ALTER TABLE `prescription`
  MODIFY `prescriptionid` int(10) NULL DEFAULT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `prescription_records`
--
ALTER TABLE `prescription_records`
  MODIFY `prescription_record_id` int(10) NULL DEFAULT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `room`
--
ALTER TABLE `room`
  MODIFY `roomid` int(10) NULL DEFAULT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT for table `service_type`
--
ALTER TABLE `service_type`
  MODIFY `service_type_id` int(10) NULL DEFAULT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `treatment`
--
ALTER TABLE `treatment`
  MODIFY `treatmentid` int(10) NULL DEFAULT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
-- AUTO_INCREMENT for table `treatment_records`
--
ALTER TABLE `treatment_records`
  MODIFY `treatment_records_id` int(10) NULL DEFAULT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `user`
--
ALTER TABLE `user`
  MODIFY `userid` int(11) NULL DEFAULT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
